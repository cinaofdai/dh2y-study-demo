...
<head>
    ...
    $this->registerMetaTag(['description' => 'description', 'content' => 'dh2y shop']);
    $this->registerMetaTag(['name' => 'author', 'content' => 'dh2y']);
    $this->registerMetaTag(['name' => 'keywords', 'content' => 'dh2y, Template, shop']);
    ...
    <title><?=Html::encode($this->title)?>- 慕课商城</title>
    <?php $this->head(); ?>
</head>
<body>
<?php $this->beginBody(); ?>
            ...
            <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
                ...
                <div class="logo">
                    <a href="<?php echo yii\helpers\Url::to(['index/index']) ?>">
                        <img alt="logo" src="/home/images/logo.PNG" width="233" height="54"/>
                    </a>
                </div><!-- /.logo -->
                <!-- ============================================================= LOGO : END ============================================================= -->
            </div><!-- /.logo-holder -->
                                ...
                                <?php foreach ((array)$this->params['cart']['products'] as $product): ?>
                                    <li>
                                        <div class="basket-item">
                                            ...
                                            <a class="close-btn"
                                               href="<?php echo yii\helpers\Url::to(['cart/del', 'cartid' => $product['cartid']]) ?>"></a>
                                        </div>
                                    </li>
                                <?php endforeach; ?>
                                <li class="checkout">
                    ...
                    <div class="collapse navbar-collapse" id="mc-horizontal-menu-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            foreach ((array)$this->params['menu'] as $menu):
                                ?>
                                <li class="dropdown">
                                    <a href="<?php echo yii\helpers\Url::to(['product/index', 'cateid' => $menu['cateid']]) ?>"
                                       class="dropdown-toggle" data-hover="dropdown"
                                       data-toggle="dropdown"><?php echo $menu['title'] ?></a>
                                    <ul class="dropdown-menu">
                                        <li>
                                                    ...
                                                    <div class="col-12 col-xs-12 col-sm-12">
                                                        <ul>
                                                            <?php foreach ((array)$menu['children'] as $child): ?>
                                                                <li>
                                                                    <a href="<?php echo yii\helpers\Url::to(['product/index', 'cateid' => $child['cateid']]) ?>"><?php echo $child['title'] ?></a>
                                                                </li>
                                                            <?php endforeach; ?>
                                                        </ul>
                                                    </div><!-- /.col -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-3 no-margin">
                                                <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $pro->productid]) ?>"
                                                   class="thumb-holder">
                                                    <img alt="<?php echo $pro->title ?>"
                                                         src="<?php echo $pro->cover ?>-picsmall"
                                                         data-echo="<?php echo $pro->cover ?>-picsmall"/>
                                                </a>
                                            </div>
                                        </div>
                                    </li>
            ...
            <div class="container">
                ...
                <div class="col-xs-12 col-sm-6 no-margin">
                    <div class="payment-methods ">
                        <ul>
                            <li><img alt="" src="/home/images/payments/payment-visa.png"></li>
                            <li><img alt="" src="/home/images/payments/payment-master.png"></li>
                            <li><img alt="" src="/home/images/payments/payment-paypal.png"></li>
                            <li><img alt="" src="/home/images/payments/payment-skrill.png"></li>
                        </ul>
                    </div><!-- /.payment-methods -->
                </div>
            </div><!-- /.container -->
